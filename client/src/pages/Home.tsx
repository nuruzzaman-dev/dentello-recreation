...
export default function Home() {
  ...
  return <div className="site-shell">
    ...
    <footer data-gsap-section className="footer"><div className="footer-top"><div className="footer-intro"><a className="brand footer-brand" href="#top"><img src={img("69e082ebd0ecc5c0a0532942_Nav%20Logo.svg")} alt="" /><span>Dentello</span></a><h2>Your trusted partner in happiness and health.</h2><p>Thoughtful dental care, modern technique, and a calmer experience from first visit to follow-up.</p></div><form onSubmit={(e) => e.preventDefault()}><label htmlFor="email">Stay in the loop</label><div><input id="email" placeholder="Enter your email" type="email" /><button className="btn" type="submit">Submit</button></div></form></div><div className="footer-nav-grid"><div><span className="footer-label">Explore</span><a href="#top">Home</a><a href="#about">About us</a><a href="#services">Services</a></div><div><span className="footer-label">Visit</span><a href="#contact">Book a consultation</a><a href="#blog">Journal</a><a href="#contact">Contact</a></div><div><span className="footer-label">Hours</span><span>Mon–Sat</span><span>9 AM – 6 PM</span><span>hello@dentello.com</span></div><div className="footer-orb"><span>Smile<br />brighter</span><ArrowUpRight size={19} /></div></div><div className="footer-bottom"><span>© 2025 Dentello. All rights reserved.</span><div><span>Made with care for every smile</span><a href="#top">Back to top ↑</a></div></div></footer>
  </div>;
}
