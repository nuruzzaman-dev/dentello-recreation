...
export default function Home() {
  ...
  return <div className="site-shell">
    ...
    <main id="top">
      ...
      <section id="blog" data-gsap-section className="section-pad blog"><Reveal><SectionHeading action="View all blog">Expert tips for maintaining healthy teeth</SectionHeading></Reveal><div className="blog-grid"><article className="featured-article"><img src={images.blog1} alt="Family dental health" /><div><p className="eyebrow">BEST PRACTICES FOR FAMILY DENTAL HEALTH</p><strong>Make every smile a healthy habit.</strong><span>Esther Howard · 5 min read · Dec 22, 2024</span></div></article><article><img src={images.blog2} alt="Technology in dental care" /><div><p className="eyebrow">HOW TECHNOLOGY IMPROVES DENTAL CARE</p><strong>Care shaped by better technology.</strong><span>Jenny Wilson · 4 min read · Dec 23, 2024</span></div></article></div></section>
    </main>

    <footer data-gsap-section className="footer"><div className="footer-top"><div className="footer-intro"><a className="brand footer-brand" href="#top"><img src={img("69e082ebd0ecc5c0a0532942_Nav%20Logo.svg")} alt="" /><span>Dentello</span></a><h2>Your trusted partner in happiness and health.</h2><p>Thoughtful dental care, modern technique, and a calmer experience from first visit to follow-up.</p></div><form onSubmit={(e) => e.preventDefault()}><label htmlFor="email">Stay in the loop</label><div><input id="email" placeholder="Enter your email" type="email" /><button className="btn" type="submit">Submit</button></div></form></div><div className="footer-nav-grid"><div><span className="footer-label">Explore</span><a href="#top">Home</a><a href="#about">About us</a><a href="#services">Services</a></div><div><span className="footer-label">Visit</span><a href="#contact">Book a consultation</a><a href="#blog">Journal</a><a href="#contact">Contact</a></div><div><span className="footer-label">Hours</span><span>Mon–Sat</span><span>9 AM – 6 PM</span><span>hello@dentello.com</span></div><div className="footer-orb"><span className="footer-smile">🙂</span><span>Smile<br />brighter</span><ArrowUpRight size={19} /></div></div><div className="footer-bottom"><span>© 2025 Dentello. All rights reserved.</span><div><span>Made with care for every smile</span><a href="#top">Back to top ↑</a></div></div></footer>
  </div>;
}
